...
<table width="100%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
  <tr valign="top">
    <td>
    	 <form action="${pageContext.request.contextPath}/employee/findEmployee" id="employeeForm" method="post">
			<!-- 隐藏表单，flag表示添加标记 -->
		  ...
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
			...
			<tr>
				<td class="font3 fftd">
					...
					name="birthday" id="birthday" size="40" value="<f:formatDate value="${employee.birthday}"
