	...
	<table width="100%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
			  ...
			  <td class="fftd">
			  	<form name="empform" method="post" id="empform" action="${pageContext.request.contextPath}/user/findUser">
				    <table width="100%" border="0" cellpadding="0" cellspacing="0">
					  <tr>
					    <td class="font3">
					    	用户名：<input type="text" name="username" <%--实现数据回显--%>value="${user.username}">
	  ...
	  <tr valign="top"><td align="center" class="font3">
		  <yyf:pager
				  ...
				  submitUrl="${pageContext.request.contextPath}/user/findUser?pageIndex={0}&username=${user.username}&status=${user.status}"/><%--处理翻页请求时应该提交到哪一个地址进行查询--%>
